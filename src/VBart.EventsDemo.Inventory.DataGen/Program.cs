...
namespace VBart.EventsDemo.Inventory.DataGen
{
    ...
    {
        private const string DefaultAspNetCoreHttpUrl = "http://localhost:5000";
        ...
        static async Task Main(string[] args)
        {
            ...
            var uri = configuration.GetServiceUri("InventoryApi")?.AbsoluteUri ?? DefaultAspNetCoreHttpUrl;
